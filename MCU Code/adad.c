...
484 bytes for displays organized as rows of vertical bytes.
****************************************************************************/
...
void  MI_TO_SH(unsigned  int  ym,unsigned  char  mm,
unsigned  char  dm)
{
...
void  SH_TO_MI(unsigned  int  ys,unsigned  char ms,
unsigned char  ds)
{
    unsigned  int  k, t1, t2; 
    ys=(0x00ff & ys);
    ...
    if (ms<10 || (ms==10 && ds <= sh_table [k-2][ms -1]))
    year= (ys - 79);
    else year= (ys - 79);
...
{
    if(Input>=1990 && Input<2099) return OK;
    else return !OK;
}

unsigned char GetDayofWeek(unsigned  char CurrentYear,
unsigned char Month ,unsigned char Day)
{
    unsigned int TempYear; 
    unsigned  char AccValue;   
    if(TEST_SAL(CurrentYear+2000)!=OK)  return Error;
    TempYear = 1990;	
    AccValue = 0;     
    ...
    if(Month>2)
    {
        if(IsLeapYear(TempYear)==1)  AccValue++;
    }  
...
0x04, 0x0E, 0x00, 0x15, 0x15, 0x0B, 0x00, 0x00, 

/* Code: 0x21, ASCII Character: '!' */
0x00, 0x00, 0x02, 0x00, 0x04, 0x1F, 0x00, 0x00, 

/* Code: 0x22, ASCII Character: '"' */
0x00, 0x00, 0x00, 0x00, 0x04, 0x1F, 0x00, 0x02, 

/* Code: 0x23, ASCII Character: '#' */
0x00, 0x00, 0x00, 0x02, 0x05, 0x19, 0x00, 0x00, 
...
0x00, 0x12, 0x12, 0x0E, 0x02, 0x02, 0x02, 0x00, 

/* Code: 0x27, ASCII Character: ''' */
0x00, 0x15, 0x15, 0x0F, 0x01, 0x01, 0x01, 0x00, 

/* Code: 0x28, ASCII Character: '(' */
0x00, 0x1D, 0x05, 0x1F, 0x01, 0x01, 0x01, 0x00, 

/* Code: 0x29, ASCII Character: ')' */
0x00, 0x04, 0x0A, 0x11, 0x11, 0x15, 0x0E, 0x00, 

/* Code: 0x2A, ASCII Character: '*' */
0x04, 0x02, 0x11, 0x0A, 0x04, 0x02, 0x01, 0x00, 

/* Code: 0x2B, ASCII Character: '+' */
0x00, 0x11, 0x11, 0x11, 0x11, 0x0A, 0x04, 0x00, 

/* Code: 0x2C, ASCII Character: ',' */
0x00, 0x04, 0x0A, 0x11, 0x11, 0x11, 0x11, 0x00, 

/* Code: 0x2D, ASCII Character: '-' */
0x00, 0x06, 0x09, 0x09, 0x0E, 0x08, 0x08, 0x00, 
...
/* Code: 0x20, ASCII Character: ' ' */
0x38, 0x22, 0x1B, 0x22, 0x18, 

/* Code: 0x21, ASCII Character: '!' */
0x20, 0x24, 0x30, 0x20, 0x20, 

/* Code: 0x22, ASCII Character: '"' */
0x20, 0xA0, 0x30, 0x20, 0x20, 

/* Code: 0x23, ASCII Character: '#' */
0x30, 0x08, 0x10, 0x20, 0x20, 
...
/* Code: 0x28, ASCII Character: '(' */
0x7E, 0x08, 0x0E, 0x0A, 0x0A, 

/* Code: 0x29, ASCII Character: ')' */
0x38, 0x44, 0x62, 0x44, 0x38, 

/* Code: 0x2A, ASCII Character: '*' */
0x44, 0x2A, 0x11, 0x08, 0x04, 

/* Code: 0x2B, ASCII Character: '+' */
0x1E, 0x20, 0x40, 0x20, 0x1E, 

/* Code: 0x2C, ASCII Character: ',' */
0x78, 0x04, 0x02, 0x04, 0x78, 
